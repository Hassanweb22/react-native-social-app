    ...
    return (
        <Stack.Navigator screenOptions={({ navigation, route }) => {
            ...
            <Stack.Screen options={({ route }) => {
                const { params: { user: { photoURL } } } = route
                    ...
                    headerLeft: () => {
                        return (
                            <TouchableOpacity activeOpacity={0.7}
                                ...
                                style={{
                                    marginLeft: 20,
                                    borderColor: "red", borderWidth: 0, flexDirection: "row",
                                ...
                                <View style={{ marginLeft: 15 }}>
                                    <Thumbnail small source={{ uri: photoURL ? photoURL : temp }}
                                        onLoadStart={() => {
