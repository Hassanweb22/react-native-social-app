...
const IndividualComments = () => {
    ...
    return (
        <View style={{ padding: 10, paddingBottom: 0 }}>
            <Card style={{ borderColor: "#000", borderWidth: 0.5, borderRadius: 10, padding: 4 }}>
                <CardItem header bordered>
                    <Left>
                        <View>
                            <Thumbnail small source={{ uri: temURI }}
                                onLoadStart={() => {
                        ...
                        <Body style={{
                            ...
                            <Text>kahsajdfhkj</Text>
                            <Text note>alkjfhnloaf apiofjalf alfn</Text>
                        </Body>
