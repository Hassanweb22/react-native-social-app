...
const IndividualComments = ({ comment }) => {
    ...
    const dateAt = new Date(comment.createdAt).toLocaleDateString() + " " + new Date(comment.createdAt).toLocaleTimeString()
    return (
        <View style={{ padding: 10, paddingBottom: 0, marginBottom: 0 }} onTouchEnd={() => console.log("comment", comment)}>
